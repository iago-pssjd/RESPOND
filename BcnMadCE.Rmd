...
kable(na.omit(eTlong, cols = "phq9")[, .(Pi = .SD[phq9 >= 10 & Randomization_Group == "Intervention", .N] / .SD[Randomization_Group == "Intervention", .N], Pc = .SD[phq9 >= 10 & Randomization_Group == "Control", .N] / .SD[Randomization_Group == "Control", .N]), by = .(time)][, NNT := 1/(Pc -Pi)][, lapply(.SD, formatC, digits = 4), .SDcols = is.numeric, by = .(time)], caption = "Crude NNT for PHQ-9") |> kableExtra::kable_styling()

kable(na.omit(eTlong, cols = "gad7")[, .(Pi = .SD[gad7 >= 10 & Randomization_Group == "Intervention", .N] / .SD[Randomization_Group == "Intervention", .N], Pc = .SD[gad7 >= 10 & Randomization_Group == "Control", .N] / .SD[Randomization_Group == "Control", .N]), by = .(time)][, NNT := 1/(Pc -Pi)][, lapply(.SD, formatC, digits = 4), .SDcols = is.numeric, by = .(time)], caption = "Crude NNT for GAD-7") |> kableExtra::kable_styling()
