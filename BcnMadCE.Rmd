...
# models <- sapply(c("phq_ads", "phq9", "gad7", "ptsd"), \(.x) {
...
modelsRG <- lapply(names(models), \(.x) emmeans(models[[.x]], specs = "Randomization_Group", by = "time", vcov. = vcCR[[.x]], mode = "appx-satterthwaite"))
