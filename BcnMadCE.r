...
writeData(wb, sheet = "PHQ-9 Reliab. item dropped", sheetDT[["alpha.drop"]])
addWorksheet(wb, sheetName = "PHQ-9 Item statistics")
writeData(wb, sheet = "PHQ-9 Item statistics", sheetDT[["item.stats"]])
addWorksheet(wb, sheetName = "PHQ-9 Non missing frequency")
writeData(wb, sheet = "PHQ-9 Non missing frequency", sheetDT[["response.freq"]])
